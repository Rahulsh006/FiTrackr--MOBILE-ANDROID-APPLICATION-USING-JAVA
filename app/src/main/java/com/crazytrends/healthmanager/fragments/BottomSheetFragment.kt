package com.crazytrends.healthmanager.fragments
...
import com.crazytrends.healthmanager.Water_MainActivity
import com.crazytrends.healthmanager.R
import com.crazytrends.healthmanager.helpers.AlarmHelper
import com.crazytrends.healthmanager.helpers.SqliteHelper
import com.crazytrends.healthmanager.utils.AppUtils
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (resultCode == Activity.RESULT_OK && requestCode == 999) {
            ...
            if (uri != null) {
                ...
                // Handle the case where uri is null, possibly show an error message or take appropriate action.
            }
        }
    }
}
